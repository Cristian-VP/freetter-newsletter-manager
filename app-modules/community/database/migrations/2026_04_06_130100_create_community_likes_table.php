...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('community_likes', function (Blueprint $table): void {
            ...
            $table->unique(['user_id', 'post_id'], 'uq_community_likes_user_post');
            $table->index(['post_id', 'created_at'], 'idx_community_likes_post_created');
            $table->index(['user_id', 'created_at'], 'idx_community_likes_user_created');
        });
    }
